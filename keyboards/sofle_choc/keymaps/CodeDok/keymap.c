...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    ...
    [GAME_SUPPORT] = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU), ENCODER_CCW_CW(LCTL(LSFT(KC_TAB)), LCTL(KC_TAB))},
};
#endif
 ...
 */
    ...
    [BASE] = LAYOUT(
        ...
        KC_ESC,   KC_Q,   KC_W,    KC_E,    KC_R,    KC_T,                            KC_Z,     KC_U,     KC_I,    KC_O,    KC_P,    KC_RPRN,
        KC_TAB,   KC_A,   KC_S,    KC_D,    KC_F,    KC_G,                            KC_H,     KC_J,     KC_K,    KC_L,    KC_ASTR, KC_LPRN,
        KC_LSFT,  KC_Y,   KC_X,    KC_C,    KC_V,    KC_B,    KC_MUTE,     KC_MPLY,   KC_N,     KC_M,     KC_COMM, KC_DOT,  KC_SLSH, KC_RALT,
                       KC_LGUI, KC_LALT,   KC_LCTL, KC_SPC,   MO(GAME),    MO(SYMB),  KC_BSPC,  KC_RCMD,  KC_RGUI, KC_RCTL
    ),
